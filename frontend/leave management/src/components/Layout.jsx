...
import panimalar26Years from "../assets/panimalar-26years.jpeg";
...
export default function Layout({ active, breadcrumb = [], children, onNavigate, user = { name: "Mr. Selvaraj", role: "Electrician Head" } }) {
    ...
    <div className="min-h-screen flex bg-slate-100 text-slate-800">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 shrink-0 bg-white border-b border-slate-200 flex items-center justify-between px-5">
          ...
          <div className="flex items-center gap-4">
            <img
              src={panimalar26Years}
              alt="Panimalar Engineering College - Celebrating 26 years"
              className="h-11 w-11 rounded-md object-cover shrink-0 hidden sm:block"
            />
