...
export default function ApprovalsRejected() {
  ...
  // Load rejected complaints and summary counts from the live backend. No
  // mock fallback: if the API is unreachable this surfaces a real error
  // instead of pretending data loaded successfully.
  useEffect(() => {
    let cancelled = false
    async function load() {
      setLoading(true)
