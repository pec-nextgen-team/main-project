  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/stock-management" element={<Navigate to="/stock-management/inventory" replace />} />
        <Route path="/stock-management/overview" element={<PlaceholderPage title="Stock Overview" />} />
        <Route path="/stock-management/inventory" element={<Inventory />} />
        <Route path="/stock-management/stock-in" element={<PlaceholderPage title="Stock In" />} />
        <Route path="/stock-management/stock-out" element={<PlaceholderPage title="Stock Out" />} />
        <Route path="/stock-management/adjustments" element={<PlaceholderPage title="Adjustments" />} />
        <Route path="/stock-management/suppliers" element={<PlaceholderPage title="Suppliers" />} />
