...
/**
 * TopHeader
 * White top navigation bar for the Accessory Repair Complaint Management System.
 */
    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-[15px] sm:text-base font-semibold text-[#062B5C]">
          Accessory Repair Complaint Management System
        </h1>
      </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left leading-tight">
              <p className="text-sm font-medium text-slate-800">Mr. Selvaraj</p>
